...
var _leaders_model = require('./leaders_model');

var _leaders_model2 = _interopRequireDefault(_leaders_model);

var LeadersCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/LeaderBoard',

  model: _leaders_model2['default'],
...
exports['default'] = LeadersCollection;
module.exports = exports['default'];

},{"./leaders_model":3,"backbone":8}],3:[function(require,module,exports){
'use strict';
...
var LeadersModel = _backbone2['default'].Model.extend({
...
exports["default"] = LeadersTemplate;
module.exports = exports["default"];
...
var _leaders_collection = require('./leaders_collection');

var _leaders_collection2 = _interopRequireDefault(_leaders_collection);

var _leaders_template = require('./leaders_template');

var _leaders_template2 = _interopRequireDefault(_leaders_template);

var APP_ID = 'Msy7YU1nO63MyrHRdDCibKmZ5deYuJrjEoKk5wY3';
var API_KEY = 'e9uV4zVnvbIAQxo3i7Wrn1601Zm7Ru5o5zl7KsMy';
...
var leaders = new _leaders_collection2['default']();

function renderLeaders() {
	// Creating an empty dom node
	var $ol = (0, _jquery2['default'])('<ol><h2>Leader Board</h2><div class="columns"><h4 class="column-rank">Rank</h4><h4 class="column-name">Name</h4><h4 class="column-score">Score</h4></div></ol>');
	...
	leaders.each(function (lead) {
		...
		var templateString = (0, _leaders_template2['default'])(data);
	...
	// set ul to the body
	(0, _jquery2['default'])('.lb-page-board').html($ol);
}
...
var playerName = (0, _jquery2['default'])('#player-name');
var enemyName = (0, _jquery2['default'])('#enemy-name');
...
(0, _jquery2['default'])('.start-game').on('click', function () {
	...
	if (pokeEnemy.health < 1000 || pokePlayer.health < 1000) {
		...
		(0, _jquery2['default'])(playerName).empty();
		(0, _jquery2['default'])(enemyName).empty();
		...
		if (selectZard.is(':checked')) {
			...
			(0, _jquery2['default'])('#player-toon').removeClass();
			(0, _jquery2['default'])('#player-toon').addClass('playertoon-zard');
			(0, _jquery2['default'])(playerName).append('Zarichard');
			(0, _jquery2['default'])(enemyName).append('Tastbloise');
			...
			(0, _jquery2['default'])(playerName).append('Xenosaur');
			(0, _jquery2['default'])(enemyName).append('Zarichard');
			...
			(0, _jquery2['default'])(playerName).append('Tastbloise');
			(0, _jquery2['default'])(enemyName).append('Xenosaur');
...
(0, _jquery2['default'])('#new-game').on('click', function () {
	...
	if ((0, _jquery2['default'])('.bottom').is(':visible') || (0, _jquery2['default'])('.main').is(':visible')) {
		(0, _jquery2['default'])('.leaderboard-page').fadeOut(500);
		(0, _jquery2['default'])('.bottom').fadeOut(500, function () {
			(0, _jquery2['default'])('.battle-option').fadeOut(500);
			(0, _jquery2['default'])('.bag').fadeOut(500);
...
(0, _jquery2['default'])('#quit-game').on('click', function () {
	...
	(0, _jquery2['default'])('.bottom').fadeOut(500, function () {
		...
		(0, _jquery2['default'])('.main').fadeOut(500, function () {
			(0, _jquery2['default'])('.select-page').fadeOut(500, function () {
				(0, _jquery2['default'])('#launch-top').fadeIn(500);
...
(0, _jquery2['default'])('.move-list-btn').on('click', function () {
	(0, _jquery2['default'])('.battle-option').fadeOut(750, function () {
...
(0, _jquery2['default'])('.bag-list-btn').on('click', function () {
	(0, _jquery2['default'])('.battle-option').fadeOut(750, function () {
		(0, _jquery2['default'])('.bag').fadeIn(750);
	});
});
...
(0, _jquery2['default'])('.lb-back').on('click', function () {
	(0, _jquery2['default'])('.leaderboard-page').fadeOut(500, function () {
		(0, _jquery2['default'])('.battle-option').fadeIn(500);
	});
});

// Got to catch them all!
(0, _jquery2['default'])('.pokeball').on('click', function () {
	(0, _jquery2['default'])('.bag').fadeOut(500, function () {
		(0, _jquery2['default'])('.battle-option').fadeIn(500);
	});
	setTimeout(function () {
		...
		setTimeout(function () {
			(0, _jquery2['default'])(combatText).empty();
			(0, _jquery2['default'])(combatText).append('..........');
			setTimeout(function () {
				audio1.pause();
				audio2.pause();
				audio3.play();
...
(0, _jquery2['default'])('.leaderboard').on('click', function () {
	(0, _jquery2['default'])('.battle-option').fadeOut(500, function () {
		(0, _jquery2['default'])('.leaderboard-page').fadeIn(500);
	});
});

// Click Move1 Function to hit enemy and display results
move1.on('click', function () {
	(0, _jquery2['default'])('.bottom').fadeOut(100, function () {
		(0, _jquery2['default'])('.battle-option').fadeIn(300);
	});

	// Generate random number to hit enemy health
	// Display damage
	var num = _underscore2['default'].random(5, 25);
	var chance = _underscore2['default'].random(1, 100);
	...
	if (chance <= 90) {
		...
		if (pokeEnemy.health <= 0) {
			...
			setTimeout(function () {
				(0, _jquery2['default'])(combatText).empty();
				(0, _jquery2['default'])(combatText).append((0, _jquery2['default'])(playerName).text() + ' used ' + (0, _jquery2['default'])(move1).text() + '.');

				// Append text to combat log of play dmg
				setTimeout(function () {
					(0, _jquery2['default'])(combatText).empty();
					(0, _jquery2['default'])(combatText).append('It hit for ' + num + ' damage.');
					...
					setTimeout(function () {
						...
						audio2.currentTime = 0;
						audio3.currentTime = 0;
						(0, _jquery2['default'])(combatText).append("Enemy Trainer's pokemon fainted... You won! Press the 'Home' button to start a new game!");
					}, 1500);
				}, 1500);
			}, 250);
			...
			// If the enemies health was not less than or equal to zero
				...
				setTimeout(function () {
					...
					setTimeout(function () {
						...
						// Append text to combat log of victory
						setTimeout(function () {
							var rand = _underscore2['default'].random(1, 4);
							var dmg1 = _underscore2['default'].random(10, 30);
							var dmg2 = _underscore2['default'].random(30, 125);
							var dmg3 = _underscore2['default'].random(75, 250);
							var dmg4 = _underscore2['default'].random(100, 500);
							var chance = _underscore2['default'].random(1, 100);
							(0, _jquery2['default'])(combatText).empty();
							...
							if (rand === 1 && chance <= 80) {
								...
								if (pokePlayer.health <= 0) {
									...
									setTimeout(function () {
										...
										setTimeout(function () {
											(0, _jquery2['default'])(combatText).empty();
											(0, _jquery2['default'])(combatText).append('It hit for ' + dmg1 + ' damage.');
											...
											setTimeout(function () {
												enemyHealth.text('FNT/1000');
												(0, _jquery2['default'])(combatText).empty();
												(0, _jquery2['default'])(combatText).append((0, _jquery2['default'])(playerName).text() + " has fainted. You are out of Pokemon! Press the 'home' button to start a new game!");
											}, 1500);
										}, 1500);
									}, 250);
								} else {
								...
								setTimeout(function () {
									...
									setTimeout(function () {
										(0, _jquery2['default'])(combatText).empty();
										(0, _jquery2['default'])(combatText).append('It missed.');
										playerHealth.text(pokePlayer.health + '/1000');
									}, 1500);
								}, 250);
								...
								if (pokePlayer.health <= 0) {
									...
									setTimeout(function () {
										(0, _jquery2['default'])(combatText).empty();
										(0, _jquery2['default'])(combatText).append('The opposing ' + (0, _jquery2['default'])(enemyName).text() + ' used ' + eMoveset[1] + '.');

										setTimeout(function () {
											(0, _jquery2['default'])(combatText).empty();
											(0, _jquery2['default'])(combatText).append('It hit for ' + dmg2 + ' damage.');
								...
								if (pokePlayer.health <= 0) {
									...
									setTimeout(function () {
										(0, _jquery2['default'])(combatText).empty();
										(0, _jquery2['default'])(combatText).append('The opposing ' + (0, _jquery2['default'])(enemyName).text() + ' used ' + eMoveset[2] + '.');

										setTimeout(function () {
											(0, _jquery2['default'])(combatText).empty();
											(0, _jquery2['default'])(combatText).append('It hit for ' + dmg3 + ' damage.');
									...
									if (pokePlayer.health <= 0) {
										...
										setTimeout(function () {
											(0, _jquery2['default'])(combatText).empty();
											(0, _jquery2['default'])(combatText).append('The opposing ' + (0, _jquery2['default'])(enemyName).text() + ' used ' + eMoveset[3] + '.');

											setTimeout(function () {
												(0, _jquery2['default'])(combatText).empty();
												(0, _jquery2['default'])(combatText).append('It hit for ' + dmg4 + ' damage.');
...
move2.on('click', function () {
	...
	if (chance <= 70) {
		...
		if (pokeEnemy.health <= 0) {
			setTimeout(function () {
				(0, _jquery2['default'])(combatText).empty();
				(0, _jquery2['default'])(combatText).append((0, _jquery2['default'])(playerName).text() + ' used ' + (0, _jquery2['default'])(move2).text() + '.');
...
move3.on('click', function () {
	...
	if (chance <= 60) {
		...
		if (pokeEnemy.health <= 0) {
			setTimeout(function () {
				(0, _jquery2['default'])(combatText).empty();
				(0, _jquery2['default'])(combatText).append((0, _jquery2['default'])(playerName).text() + ' used ' + (0, _jquery2['default'])(move3).text() + '.');
...
move4.on('click', function () {
	...
	if (chance <= 50) {
		...
		if (pokeEnemy.health <= 0) {
			setTimeout(function () {
				(0, _jquery2['default'])(combatText).empty();
				(0, _jquery2['default'])(combatText).append((0, _jquery2['default'])(playerName).text() + ' used ' + (0, _jquery2['default'])(move4).text() + '.');
...
},{"./enemy":1,"./leaders_collection":2,"./leaders_template":4,"./moves":6,"./player":7,"jquery":9,"moment":10,"underscore":11}],6:[function(require,module,exports){
"use strict";
...
var Movesets = function Movesets(set) {
	...
	this.eThree = set.eThree;
	this.four = set.four;
	this.eFour = set.eFour;
};
...
},{"./moves":6}],8:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
